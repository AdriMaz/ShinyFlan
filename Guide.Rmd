...
***
## Contact
For any question, remark, or bug, please feel free to send a mail at [mazoyer(dot)adrien(at)courrier(dot)uqam(dot)ca](mailto:mazoyer.adrien(at)courrier.uqam.ca) or to report it [here](https://github.com/AdriMaz/ShinyFlan/issues).
